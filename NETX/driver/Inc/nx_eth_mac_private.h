...
#ifndef NX_ETH_MAC_PRIVATE_H
#define NX_ETH_MAC_PRIVATE_H
...
/**
  \struct NX_MAC_DRIVER
  \brief  Represents the driver instance.
*/
typedef struct NX_MAC_DRIVER_STRUCT
{
    ...
    MAC_DEV     *nx_driver_dev;            /**< Pointer to \ref MAC_DEV owned by this driver */
